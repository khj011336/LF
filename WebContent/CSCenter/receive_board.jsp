...
<div id="receiveBoard_wrapper">
	<div id="receiveBoard_content">
		<div class="receiveBoard_content_title">
			<span class=""></span> 쿠폰적용은 어떤식으로 하는게 좋을까요? <span class="divider">|</span>
			<span class="receiveBoard_category"> <a href="#">쿠폰</a></span> <span
				class="titleRight"> <span class="readWriterTime">
					2020-04-10 15:52:48 </span>
			</span>
		</div>
		<div id="writeInfo">
			<div id="readHead">
				<div class="readLeft">
					<i class="#"> </i> <strong> <a rel="#">김건우</a>
					</strong> <span class="receiveBoradgrade">일반회원</span>
				</div>
			</div>
		</div>
