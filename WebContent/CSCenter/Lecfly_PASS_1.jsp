...
<body>
    <div class="section">
        <div id="sec_title"><h2>홈페이지 안내</h2></div>
            <div id="sec_subtitle">
                <ul>
                    <li><h4><a href="Lecfly_PASS_1.html" style="background-color: orange">이용안내</a></h4></li>
                    <li><h4><a href="Lecfly_PASS_2.html">회원권</a></h4></li>
                </ul>
            </div>
            
            <div class="lecflyis">
                <div id="lecflyis_logo"><br><br><h1>&#91;LECFLY LOGO&#93;</h1></div>
                ...
                <div id="lecflyis_maintxt"><h3><p>
                    ...
                    보통의 하루가 끝나고 나만의 시간이 필요할 땐, 취미 정보가 가득한 Lecfly로 오세요<br><br>
                    전문작가들의 클래스를 오프라인 클래스보다 합리적인 가격에 즐길 수 있으며<br><br>
                    클래스에 필요한 준비물은 최저가로 구성하여 집앞으로 배송해드립니다.</p></h3>
                    </div>
                <div id="lecflyis_title2"><h1><span style="background-color: purple;">
