...
<ul class="side-menu">
	...
	<li><a href="#" class="nav_funding"><span class="fas fa-funnel-dollar"></span>펀딩목록</a></li>
	<!-- <li><a href="#" class="nav_wish_list"><span class="fas fa-heartbeat"></span>관심클래스</a></li> -->
	<li><a href="#" class="nav_cart"><span class="fas fa-credit-card"></span>장바구니</a></li>
	<li><a href="#" class="nav_mypage"><span class="fas fa-user"></span>마이페이지</a></li>
	<li><a href="<%= ROOT %>/Creator/creatorcenter.jsp" ><span class="fas fa-chalkboard-teacher"></span>크리에이터센터</a></li>
