...
<div class="main_video_wrapper">
	...
	<div class="main_video_block_row"> <!-- 한 행에 전시할 강의 시작점마다 -->
		<div class="main_video_block">
			...
			<a href="#"><div class="main_video_thumb_btn"><i class="far fa-heart fa-2x"></i></div> <img src="resource/img/dummy_lec_img/art/art_2m.jpg" alt="lecfly lecture"></a>
			</div>
			<div class="main_video_info">
				<p class="main_video_info_category">미술</p>
				
				<p class="main_video_info_title">"쉽게 배우는 흙과 나의 손끝으로 생성되는 나만의 작은 세상"</p>
		...
		<div class="main_video_block">
			<div class="main_video_thumb">
			<a href="#"><div class="main_video_thumb_btn"><i class="far fa-heart fa-2x"></i></div> <img src="resource/img/dummy_lec_img/art/art_5m.jpg" alt="lecfly lecture"></a>
			</div>
			<div class="main_video_info">
				<p class="main_video_info_category">미술</p>
				
				<p class="main_video_info_title">"문신의 원리와 역사 그리고 매커니즘에 대하여 / 타투머신 사용법"</p>
		...
		<div class="main_video_block">
			<div class="main_video_thumb">
			<a href="#"><div class="main_video_thumb_btn"><i class="far fa-heart fa-2x"></i></div> <img src="resource/img/dummy_lec_img/currier/currier_5m.jpg" alt="lecfly lecture"></a>
			</div>
			<div class="main_video_info">
				<p class="main_video_info_category">커리어</p>
				
				<p class="main_video_info_title">"드라마속 여주인공처럼 교감과 운동을 승마를 통해 얻어보자"</p>
		...
		<div class="main_video_block">
			<div class="main_video_thumb">
			<a href="#"><div class="main_video_thumb_btn"><i class="far fa-heart fa-2x"></i></div> <img src="resource/img/dummy_lec_img/exercise/exercise_5m.jpg" alt="lecfly lecture"></a>
			</div>
			<div class="main_video_info">
				<p class="main_video_info_category">운동</p>
				
				<p class="main_video_info_title">"초심자도 따라하는 암벽등반. 영화 속 영웅처럼 벽을 올라가자"</p>
	...
	<div class="main_video_block_row"><!-- 한 행에 전시할 강의 시작점마다 -->
		...
		<div class="main_video_block">
			<div class="main_video_thumb">
			<a href="#"><div class="main_video_thumb_btn"><i class="far fa-heart fa-2x"></i></div> <img src="resource/img/dummy_lec_img/trable/trable_2m.jpg" alt="lecfly lecture"></a>
			</div>
			<div class="main_video_info">
				<p class="main_video_info_category">여행</p>
				
				<p class="main_video_info_title">"배낭 하나에 필요한 물건들을 모두 챙겨 세계로 떠나보자"</p>
		...
		<div class="main_video_block">
			<div class="main_video_thumb">
			<a href="#"><div class="main_video_thumb_btn"><i class="far fa-heart fa-2x"></i></div> <img src="resource/img/dummy_lec_img/trable/trable_8m.jpg" alt="lecfly lecture"></a>
			</div>
			<div class="main_video_info">
				<p class="main_video_info_category">여행</p>
		...
		<div class="main_video_block">
			<div class="main_video_thumb">
			<a href="#"><div class="main_video_thumb_btn"><i class="far fa-heart fa-2x"></i></div> <img src="https://cdn.class101.net/images/5212f4a6-8ae0-4252-aaa4-c6537fc91a3b/1600xauto" alt="lecfly lecture"></a>
			</div>
			<div class="main_video_info">
				<p class="main_video_info_category">미술</p>
