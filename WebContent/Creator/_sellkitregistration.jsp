	...
	<div id="sellkitregistration_wrap" class="sellkitregistration_wrap_cont_div">
        ...
        <div id="sellkitregistration_main" class="sellkitregistration_main_cont_div">
            ...
            <div class="sellkitregistration_main_top_div">
                <div class="sellkitregistration_nav_part1_div">
                    <div class="sellkitregistration_mini_title_interval">
                        ...
                        <div class="sellkitregistration_nav1_div"><label for="sellkitregistration_item_cate" class="creator_h4">상품 카테고리</label></div>
                    ...
                    <div class="sellkitregistration_mini_title_interval">
                        ...
                        <div class="sellkitregistration_nav1_div"><label for="sellkitregistration_item_name" class="creator_h4">상품명</label></div>
                        <input type="text" class="sellkitregistration_input_bar2" id="sellkitregistration_item_name" name="sellkitregistration_item_name" >
                    </div>
                    <div class="sellkitregistration_mini_title_interval">
                        <div class="sellkitregistration_nav1_div"><label for="sellkitregistration_item_price" class="creator_h4">판매가</label></div>
                    ...
                    <div class="sellkitregistration_mini_title_interval">
                        ...
                        <div class="sellkitregistration_nav1_div"><label for="sellkitregistration_item_count" class="creator_h4">재고수량</label></div>
                ...
                <div class="sellkitregistration_nav_part2_div">
                    <div class="sellkitregistration_mini_title_interval">
                        ...
                        <div class="sellkitregistration_nav2_div" class="creator_h4">상품속성</div>
                        <div class="sellkitregistration_btn2_div sellkitregistration_background_color_yellow_div color_white">속성설정</div>
                    </div>
                    <div class="sellkitregistration_mini_title_interval">
                    
                        <div class="sellkitregistration_nav2_div" class="creator_h4">부가세</div>
            ...
            <div class="sellkitregistration_main_center_div">
                ...
                <div class="sellkitregistration_nav1_div sellkitregistration_nav1_dummy_div creator_h4">상품이미지</div>
                ...
                <span class="sellkitregistration_dummy_span creator_h4"> - 최대 10장까지 추가 가능합니다</span>
            ...
            <div class="sellkitregistration_main_bottom_div">
                <div class="sellkitregistration_main_bottom_part1_div">
                    <div class="sellkitregistration_mini_title_interval">
                        ...
                        <div class="sellkitregistration_nav1_div"><label for="sellkitregistration_delivery_company" class="creator_h4">택배사</label></div>
                    ...
                    <div class="sellkitregistration_mini_title_interval sellkitregistration_nav_part3_div">
                        ...
                        <div class="sellkitregistration_nav2_div"><label for="sellkitregistration_delivery_price" class="creator_h4">배송비</label></div>
                ...
                <div class="sellkitregistration_main_bottom_part2_div">
                    <div class="">
                        ...
                        <div class="sellkitregistration_nav1_div"><label for="sellkitregistration_delivery_adress" class="creator_h4">발송지</label></div>
                    ...
                    <div class="sellkitregistration_mini_title_interval">
                        ...
                        <div class="sellkitregistration_nav1_div"><label for="sellkitregistration_delivery_guide_msg" class="creator_h4">배송안내문구</label></div>
...
<!--                margin-top 20px -->            
                    <div class="sellkitregistration_nav1_div"><label for="" class="creator_h4">상세정보등록</label></div>
...
<!--                margin-top 20px -->
                    <div class="sellkitregistration_nav1_div sellkitregistration_nav_dummy2_div"><label for="sellkitregistration_detail_info_registration" class="creator_h4">내용</label></div>
